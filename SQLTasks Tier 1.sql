...
4 facilities do not charge, as identified using the below code.
...
SELECT f.name, b.facid, b.starttime, f.membercost, f.guestcost, m.surname, m.firstname
FROM Bookings AS b
LEFT JOIN Facilities AS f ON b.facid = f.facid
...
**PART 2 ANSWERS IN SEPARATE FILE LABELED SQLite_SQL.ipynb**
